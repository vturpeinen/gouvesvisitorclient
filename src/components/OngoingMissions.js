        ...
        return (
                    ...
                    <div className="col-xs-12 col-sm-4">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div className="ongoing-box">
                                ...
                                <br id="NewShelter"/>We might not change everything in a month, or in a year, but we can change so many lives and in long term, help make the whole island better place for the animals that have no voice.
                                 </p>
                                 <br/>
                            </div>
                        </div>     
            ...
            <div className="wrapper shelterwrapper">
                    <div className="row shelterrow"> 
                        <div className="col-xs-12 col-sm-4">
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <div className="shelter-box">
                                    ...
                                    <br/>We are trying to find anohter suitable place and once we have all the options figured out, we will start the bigger task of fundraising for the new shelter. This might be the perfect opportunity to get free range shelter, with no chains and suitable place for sick and injured animals.<br/>
                                    </p>
                                    <br/>
                                </div>
                            </div> 
                        ...
                        <div className="wrapper neuterwrapper" id="Neutering">
